  ...
  return (
    <div className="space-y-6 pl-3">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard title="Total Published Posts" value={loading ? "..." : stats.totalPosts} color="text-blue-600" />
        <StatCard title="Authored by You" value={loading ? "..." : stats.myPosts} color="text-green-600" />
        <StatCard title="Posts with Images" value={loading ? "..." : stats.postsWithImages} color="text-purple-600" />
        <StatCard title="Latest Activity" value={loading ? "..." : stats.lastPostDate} color="text-amber-600" isText={true} />
      </div>
